...
Original file is located at
    https://colab.research.google.com/drive/1dSHEdSSquWuskHEO_LBhhnRELX0IlAVS
"""

Librarians=[["Rajesh","1234"],["Sarita","4321"]]
Students=[["Raj","1111"],["Sandeep","2222"],["Manali","3333"],["Manoj","4444"],["Krishna","5555"],["Tejas","6666"],["Bhuvan","7777"],["Sandhya","9999"]]
Rack_Book=[["Physics","Einstin","1001"],["Physics","Einstin","1002"],["Physics","Edison","1003"],["Physics","Einstin","1004"],["Physics","Einstin","1005"],\
       ["Chemistry","Einstin","2001"],["Chemistry","Thamos","2002"],["Chemistry","Einstin","2003"],["Chemistry","Nobel","2004"],["Chemistry","Einstin","2005"]]
Dispatch_Book=[]
Student_Detail=[]
class Library():
    Librarians=[["Rajesh","1234"],["Sarita","4321"]]
    ...
    def Issued_Books(self):
        print("------------------------------------------------------")
        print("Book name"," "*9,"Author Name"," "*9,"Book ID"," "*9,)
        print("------------------------------------------------------")
        for i in range(len(lib.Dispatch_Book)):
            print(lib.Dispatch_Book[i][0]," "*(20-len(lib.Dispatch_Book[i][0])),lib.Dispatch_Book[i][1]," "*(20-len(lib.Dispatch_Book[i][1])),lib.Dispatch_Book[i][2]) #," "*(20-len(lib.Student_Detail[i][0]))
            print("___________________________________________________")
   
    def Stud_detail(self,Stname):
        if [name] not in lib.Student_Detail:
            Student_Detail=self.Student_Detail.append([Stname])
            print('Thanks', Stname)
...
while(True):
    ...
    if opt1==1:
        ...
        while (i<4):
            ...
            if [usrlib,pinlib] in Librarians:
            ...
            if [usrstd,pinstd] in lib.Students:
                ...
                while(True):
                    ...
                    if opt2==1:
                        ...
                        name=input("Please Enter your Book Name:")
                        author=input("Please Enter your Book Author:")
                        Bids=input("Please Enter your Book Id:")
                        lib.Collect_Books(name.capitalize(),author.capitalize(),Bids)
                        lib.Stud_detail(usrstd.capitalize())
                    elif opt2==2:
                        name=input("Please Enter your Book Name:")
                        author=input("Please Enter your Book Author:")
                        Bid=input("Please Enter your Book Id:")
